...
\begin{document}
	...
	\institute{Ciencias de la Computación, Grupos 312, Universidad de La Habana\\
		\and Ciencia de Datos, Grupos 311 y 312, Universidad de La Habana\\
	...
	\begin{figure}[t]
		\centering
		\framebox[0.9\textwidth][c]{\rule{0pt}{4.2cm}\parbox{0.8\textwidth}{\centering
				\emph{[Insertar aquí la captura real de la interfaz.]}\\[2mm]
				\scriptsize Sustituir por: \texttt{\textbackslash includegraphics[width=\textbackslash textwidth]{figuras/ui-busqueda.png}}.
				Para generarla: ejecutar \texttt{python ui/app.py}, abrir
				\texttt{http://localhost:8501}, realizar una consulta y capturar la pantalla.}}
		\caption{Interfaz de ShealtRI: barra de búsqueda con conmutadores (corrección
			ortográfica e inclusión de resultados web), tarjetas de resultados ordenadas por
			relevancia con insignias de origen, y panel lateral con la respuesta RAG.}
		\label{fig:ui}
	\end{figure}
